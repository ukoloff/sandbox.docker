...
target "bash" {
  ...
  dockerfile-inline = <<-EOT
    ...
    RUN <<EOX
      ...
      for ext in EditorConfig.EditorConfig  fabiospampinato.vscode-open-in-github  mhutchie.git-graph  rogalmic.bash-debug  mads-hartmann.bash-ide-vscode  timonwong.shellcheck
      do
